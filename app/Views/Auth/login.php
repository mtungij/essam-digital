                ...
                <form class="space-y-4 md:space-y-6" action="/auth" method="post">
                    ...
                    <div>
                        ...
                        <input type="text" name="username" id="username"
                            ...
                            placeholder="••••••••" value="<?= set_value('username') ?>">
                    </div>
                    <div>
                        <label for="password"
                    ...
                    <button type="submit"
                        class="w-full text-black bg-yellow-300 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign
                        in</button>
                </form>
            </div>
        </div>
