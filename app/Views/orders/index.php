    ...
    <div class="w-full">
     ...
     <div class="sm:px-6 py-8 flex flex-col rounded-xl bg-white dark:bg-gray-900">
          <?php if(session()->has('successcreate')): ?>
           ...
           <p> <?= session()->getFlashdata('successcreate') ?></p> <a href="#" class="font-semibold underline hover:no-underline">example link</a>. Give it a click if you like.
            </div>
            </div>
            </div>
      <?php endif?>
        ...
        <div class="bg-white dark:bg-gray-800 relative w-full  sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    <form class="flex items-center" action="/orders">
